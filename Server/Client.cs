    ...
    class Client
    {
        ...
        public class TCP
        {
            ...
            public void Connect(TcpClient _socket)
            {
                ...
                ServerSend.InitialConnection(id);
        ...
        {
            Console.WriteLine($"[Client {_id}: {Server.clients[_id].tcp.socket.Client.RemoteEndPoint}]: Disconnected");
            Server.ConnectedClientsIndex -= 1;
